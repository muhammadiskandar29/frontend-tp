...
export default function DaftarPesanan() {
  ...
  const handleFilterApply = (newFilters) => {
    ...
    // Note: product search results/data might be lost if we don't handle selectedProductsData
    // But since filters.products is IDs, it should trigger fetchOrders with correct params.
    setPage(1);
  };
