...
export default function AddBroadcast({ onClose, onAdd }) {
  ...
  return (
    <>
      <style>{`
        /* Responsive Styles untuk AddBroadcast */
        @media (max-width: 768px) {
          .add-broadcast-modal .orders-modal-card {
            max-width: 95vw !important;
            max-height: 95vh !important;
            margin: 1rem !important;
          }
          
          .add-broadcast-modal .orders-modal-header h2 {
            font-size: 1.25rem !important;
          }
          
          .add-broadcast-modal .orders-field input,
          .add-broadcast-modal .orders-field textarea,
          .add-broadcast-modal .orders-field select {
            font-size: 16px !important;
          }
          
          .add-broadcast-modal .orders-field label {
            font-size: 0.875rem !important;
          }
          
          .add-broadcast-modal .orders-field label small {
            display: block !important;
            margin-left: 0 !important;
            margin-top: 0.25rem !important;
          }
          
          /* Control Row untuk Autotext & Emoji */
          .add-broadcast-modal .orders-field + div[style*="display: flex"] {
            flex-direction: column !important;
            gap: 0.5rem !important;
          }
          
          .add-broadcast-modal .orders-field + div[style*="display: flex"] > div {
            width: 100% !important;
          }
          
          .add-broadcast-modal .orders-field + div[style*="display: flex"] select {
            width: 100% !important;
            min-width: auto !important;
          }
          
          /* Emoji Picker Button */
          .add-broadcast-modal .orders-field + div[style*="display: flex"] > div[style*="position: relative"] {
            width: 100% !important;
          }
          
          .add-broadcast-modal .orders-field + div[style*="display: flex"] > div[style*="position: relative"] > button {
            width: 100% !important;
            justify-content: center !important;
          }
          
          /* Status Button */
          .add-broadcast-modal button[style*="borderRadius: 999px"] {
        ...
        @media (max-width: 480px) {
          ...
          .add-broadcast-modal .orders-modal-header {
          ...
          .add-broadcast-modal .orders-modal-body {
            padding: 1rem !important;
          }
          
          .add-broadcast-modal .orders-modal-footer {
            flex-direction: column !important;
            gap: 0.5rem !important;
            padding: 1rem !important;
          }
          
          .add-broadcast-modal .orders-modal-footer button {
            width: 100% !important;
          }
          
          /* Produk Search Input */
          .add-broadcast-modal input[placeholder="Cari produk..."] {
            font-size: 16px !important;
          }
          
          /* Chips Produk Terpilih */
          .add-broadcast-modal span[style*="display: inline-flex"] {
            font-size: 0.75rem !important;
            padding: 0.375rem 0.625rem !important;
          }
          
          /* Info Box */
          .add-broadcast-modal div[style*="background: #f0f9ff"] {
      ...
      `}</style>
      <div className="orders-modal-overlay add-broadcast-modal" onClick={onClose}>
