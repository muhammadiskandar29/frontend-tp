...
export default function BroadcastPage() {
  ...
  return (
    <Layout title="Broadcast | Sales Dashboard">
      <style>{`
        /* Responsive Styles untuk Broadcast Page */
        @media (max-width: 768px) {
          .broadcast-page .orders-toolbar {
            flex-direction: column !important;
            gap: 1rem !important;
          }
          
          .broadcast-page .orders-toolbar-buttons {
            width: 100% !important;
          }
          
          .broadcast-page .orders-toolbar-buttons button {
            width: 100% !important;
          }
          
          .broadcast-page .broadcast-table .orders-table__head {
            display: none !important;
          }
          
          .broadcast-page .broadcast-table .orders-table__row {
          ...
          .broadcast-page .broadcast-table .orders-table__cell {
          ...
          .broadcast-page .broadcast-table .orders-table__cell::before {
            content: attr(data-label) ": " !important;
            font-weight: 600 !important;
            margin-right: 0.5rem !important;
          }
          
          .broadcast-page .broadcast-table .orders-table__cell--actions {
            flex-direction: column !important;
            gap: 0.5rem !important;
          }
          
          .broadcast-page .broadcast-table .orders-table__cell--actions::before {
            display: none !important;
          }
          
          .broadcast-page .broadcast-table .orders-action-btn {
            width: 100% !important;
        ...
        @media (max-width: 480px) {
          .broadcast-page .dashboard-hero__title {
            font-size: 1.5rem !important;
          }
          
          .broadcast-page .panel__title {
      ...
      `}</style>
      <div className="dashboard-shell orders-shell broadcast-page">
