...
export default function PaymentHistoryModal({ orderId, isOpen, onClose }) {
  ...
  const fetchPaymentHistory = async () => {
    ...
    try {
      ...
      // Menggunakan endpoint sales payment history by order
      ...
      >
        ...
        >
          ...
          >
            <div>
              <p
                className="orders-modal-eyebrow"
                style={{
                  fontSize: "0.875rem",
                  color: "#6b7280",
                  margin: "0 0 0.25rem",
                  ...
                  >
                    <div>
                      ...
                      <strong style={{ display: "block", color: "#111827" }}>
                        {paymentHistoryData.order?.customer_rel?.nama || "-"}
                      </strong>
                    </div>
                    <div>
                      <span style={{ color: "#6b7280" }}>Produk:</span>
                      <strong style={{ display: "block", color: "#111827" }}>
                        {paymentHistoryData.order?.produk_rel?.nama || "-"}
                      </strong>
                    </div>
                    <div>
                      <span style={{ color: "#6b7280" }}>Total Harga:</span>
                      <strong style={{ display: "block", color: "#111827" }}>
                        Rp {Number(paymentHistoryData.order?.total_harga || 0).toLocaleString("id-ID")}
                      </strong>
                    </div>
                  </div>
                </div>
                          ...
                          >
                            <div>
                              <strong style={{ fontSize: "0.95rem", color: "#111827" }}>
                                Pembayaran ke {payment.payment_ke || idx + 1}
                              </strong>
